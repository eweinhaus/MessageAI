...
export default function SummaryPage() {
  ...
  // Loading state with unread count
  if (loading) {
    return (
        ...
        <View style={styles.container}>
          <View style={styles.loadingContainer}>
            ...
            <Text style={styles.loadingText}>
              {unreadCount > 0 
                ? `You have ${unreadCount} unread message${unreadCount !== 1 ? 's' : ''}. Loading summary...`
                : 'Loading summary...'}
            </Text>
  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={['bottom']}>
      ...
      >
        ...
        {/* Chats with Updates */}
        {summary.chats && summary.chats.length > 0 && (
          <SummarySection title="Chats with Updates" icon="chatbubbles">
            {summary.chats.map((chat, index) => (
              <TouchableOpacity
                key={index}
              ...
              >
                <View style={styles.chatCardHeader}>
                  <Text style={styles.chatCardTitle}>{chat.chatName}</Text>
                  <Text style={styles.chatCardCount}>
                    {chat.messageCount} unread
                  </Text>
                </View>
                {chat.summary && (
                  <Text style={styles.chatCardSummary} numberOfLines={2}>
                    {chat.summary}
                  </Text>
                )}
              </TouchableOpacity>
